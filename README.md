...
keep-alive, `100-continue`, protocol switching, and error handling. See the
[cookbook](docs/cookbook.md) for compiled examples of pipelining,
`100-continue`, and Upgrade handoff.
